...
def insert_category(
    ...
    query = "INSERT INTO task_categories " "(cname) " "VALUES (%s)"
...
def delete_category_row(
    ...
    delete_dept_mapping_query = "DELETE FROM dept_categories " "WHERE cname = %s"
    delete_category_query = "DELETE FROM task_categories " "WHERE cname = %s"
